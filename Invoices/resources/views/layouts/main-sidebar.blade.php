    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround" src="{{ Auth::user()->profile_photo_url }}"><span
        ...
        <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('unpaid_invoices') }}">الفواتير غير
                                    المدفوعة</a></li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('partial_paid_invoices') }}">الفواتير المدفوعة
                                    حزئياً</a></li>
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ route('archieve.index') }}">أرشيف الفواتير</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            ...
            @can('الاعدادات')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('الاقسام')
                            <li><a class="slide-item" href="{{ route('categories.index') }}">الأقسام</a></li>
                        @endcan
                        @can('المنتجات')
